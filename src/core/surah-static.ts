/** Static surah names, revelation order, and ruku counts (shared by /v1/surahs and /v1/structure). */
export const SURAH_NAMES: Record<number, { arabic: string; transliteration: string; english: string; type: string; order: number; rukus: number }> = {
